"""ECOD (Empirical Cumulative Distribution) implementation for Stage 1."""
...
class ECOD(Stage1Model):
    ...
    def fit(self, x_values: NDArray) -> None:
        """Train ECOD model."""
        self.model = PyODECOD(contamination=self.contamination, **self.hyperparams)
